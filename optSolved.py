...
# thresholds = getThresholdsFromGts(Gts, file='predictionsDay50.txt')
# print("Thresholds: ", thresholds)

# # thresholds = [0] + thresholds + [3129.52612]
# # k = .01 / 1000
# # c = 1
# # delta = 0.05
# # epsilon = [k * .01/1000] / sum(i**(1/) for i in Gts)

# # def minimizeSpace(startThreshold, endThreshold):
# #     error = k * 
